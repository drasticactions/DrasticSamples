...
namespace DotnetRss.ViewModels
{
    ...
    /// </summary>
    public class RssFeedArticleViewModel : DotnetRssBaseViewModel
    {
        private IFeedBrowser webview;
        private string html;
        ...
        public RssFeedArticleViewModel(IFeedBrowser webview, IServiceProvider services, FeedListItem? feedListItem = null, FeedItem? item = null)
            : base(services)
        {
